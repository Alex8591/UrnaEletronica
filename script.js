   ...
   if(votoConfirmado) {
       ...
       if(etapas[etapaAtual] !== undefined) {
           comecarEtapa();
            ...
            let element = document.getElementById("barraAnimada");
            ...
            function cena() {
                ...
                if( width >= 100 ) {
                    ...
                    localStorage.setItem('itens', JSON.stringify(votos));
                    dataGet();
                    console.log(votacao);
                    function dataGet(){
                        let votar = localStorage.getItem("itens") || 'nome';
                        
                        votacao = votar;
                        let blob = new Blob([votacao], {
